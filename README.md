...
Many of the this brute force rc scripts are written to accept **user inputs** (setg global variables). This means that users can run this resource scripts in 3 diferent ways:
